...
@Component({
  selector: 'app-mech-job-cameras',
  templateUrl: './mech-job-cameras.component.html',
  styleUrls: ['./mech-job-cameras.component.css']
})
export class MechJobCamerasComponent implements OnInit, OnDestroy, AfterViewInit
{
  ...
  OnAddCameraDetails() {
    ...
    if (this.isFormValid) {
      ...
      if (this.AddCameraForm.get("rtsp_url").value) {
        ...
        if (
          this.AddCameraForm.get("isHooter") ||
          this.AddCameraForm.get("isRelay")
        ) {
          var data1: any = {
            ...
            alarm_type: {
              hooter: this.AddCameraForm.get("isHooter").value,
              relay: this.AddCameraForm.get("isRelay").value,
            },
            // alarm_enable:{hooter:this.AddCameraForm.get('isHooter').value,relay:this.AddCameraForm.get('isRelay').value},
            alarm_enable: true,
            alarm_ip_address: {
              hooter_ip: this.AddCameraForm.get("isHooter").value
                ? this.AddCameraForm.get("hooterIp").value
                : null,
              relay_ip: this.AddCameraForm.get("isRelay").value
                ? this.AddCameraForm.get("hooterIp").value
                : null,
            },
          };
          ...
          var data1: any = {
            ...
            alarm_ip_address: {
              hooter_ip: this.AddCameraForm.get("isHooter").value
                ...
                : null,
              relay_ip: this.AddCameraForm.get("isRelay").value
                ? this.AddCameraForm.get("relayIp").value
                : null,
            },
          };
        }
        ...
        if (
          this.AddCameraForm.get("isHooter") ||
          this.AddCameraForm.get("isRelay").get("isRelay")
        ) {
          var data: any = {
            cameraname: this.AddCameraForm.value["cameraname"],
            camera_brand: this.AddCameraForm.value["camera_brand"][0].text,
  ...
  EditCameraModal(modal: any, data: any) {
    ...
    if (data.alarm_type.hooter) {
      //
      this.isSensgiz = false;
      this.EditCameraForm.get("isHooter").setValue(true);
      this.EditCameraForm.get("hooterIp").setValue(
    ...
    if (data.alarm_type.relay) {
      this.isSensgiz = false;
      this.EditCameraForm.get("isRelay").setValue(true);
      this.EditCameraForm.get("relayIp").setValue(
    ...
    if (true) {
      ...
      if (
        ...
        var data1: any = {
          ...
          alarm_type: {
            hooter: this.EditCameraForm.get("isHooter").value,
            relay: this.EditCameraForm.get("isRelay").value,
          },
          alarm_enable: true,
          alarm_ip_address: {
            hooter_ip: this.EditCameraForm.get("hooterIp").value
              ? this.EditCameraForm.get("hooterIp").value
              : null,
            relay_ip: this.EditCameraForm.get("relayIp").value
              ? this.EditCameraForm.get("relayIp").value
              : null,
          },
        };
        console.log(data1);
      ...
      //altered
        ...
        var data1: any = {
          ...
          alarm_enable: true,
          alarm_ip_address: {
            hooter_ip: this.EditCameraForm.get("isHooter").value
              ? this.EditCameraForm.get("hooterIp").value
              : null,
            relay_ip: this.AddCameraForm.get("isRelay").value
              ? this.AddCameraForm.get("relayIp").value
