...
ChangePanelName() {
  this.PanelData[0].panel_data[this.selectedId].panel_id = this.tempPanelID.value
  ...
  this.PanelData[0].panel_data[this.selectedId].roi_data.panel_number = this.tempPanelID.value
...
AlterPanelName(id: number) {
  ...
  this.tempPanelID.setValue(this.PanelData[0].panel_data[id].panel_id)
...
GetPanelPoints() {
  this.PanelData[0].panel_data.forEach((points: any, id: number) => {
    console.log(points)
