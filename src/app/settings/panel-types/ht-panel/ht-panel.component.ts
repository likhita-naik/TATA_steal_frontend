...
export class HtPanelComponent {
  ...
  OnAddingNewPanel() {
    ...
    if (!exist) {
      ...
      const currentPanel = new fabric.Polygon(tempPoints,(this.unallocatedJobStatus?this.polygonOptions3:this.polygonOptions));
      ...
      if (panelName != null) {
        ...
        var panelNameObject = new fabric.Text(panelName, {
          ...
          top: dimensions.top,
          stroke: this.unallocatedJobStatus? "rgb(255, 255, 0)": "rgb(127, 255, 0)",
          fill:this.unallocatedJobStatus? "rgb(255, 255, 0)": "rgb(127, 255, 0)",
        });
  ...
  DrawExistPanels() {
    this.PanelsRoiPoints.forEach((element: any, id: number) => {
      ...
      var Polygon: any = new fabric.Polygon(element.panel, {
        ...(element.unallocatedJobStatus?this.polygonOptions3:this.polygonOptions),
        id: id,
      });
      ...
      var text = new fabric.Text(
          ...
          : element.panel_id,
        {
          ...
          top: Polygon.top,
          stroke:element.unallocatedJobStatus? "rgb(255, 255, 0)": "rgb(127, 255, 0)",
          fill: element.unallocatedJobStatus? "rgb(255, 255, 0)" :"rgb(127, 255, 0)",
        }
      );
